...
- **"Get set up" card** — a self-checking onboarding path (first log, goals, nutrition, book, reminders, money snapshot) that deep-links each step, shows progress, and auto-disappears when complete.
